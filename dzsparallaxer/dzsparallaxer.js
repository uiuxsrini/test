            ...
            function handle_scroll(e, pargs){
                ...
                if(duration_viy===0){
                    ...
                    if(sw_suspend_functional==false || 1==1){
                        //console.info('DURATION VIY = 0', vi_y, target_viy)
                        if(is_ie()&&version_ie()<=10){
            ...
            function handle_frame(){
                ...
                if(is_ie()&&version_ie()<=10){
                    ...
                    if(isiPad){
                        ...
                        //_theTarget.css("opacity", .99);
                        //setTimeout(function(){
                        //    _theTarget.css("opacity", 1);
                        //},20);

                        //_theTarget[0].style.display='none';
                        //var temp = _theTarget[0].offsetHeight; // no need to store this anywhere, the reference is enough
                        //_theTarget[0].style.display='';
